...
var (
	addr      = flag.String("listen", ":6161", "address to bind to")
	workers   = flag.Int("workers", 4, "max workers count")
...
func main() {
	...
	handle := func(conn net.Conn) {
		...
		poller.Start(desc, func(ev netpoll.Event) {
			...
			pool.Schedule(func() {
				/*
					TODO: process incomming commands
